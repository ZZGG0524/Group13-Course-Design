...
public class UpController {
    ...
    @RequiresPermissions("uploadVideo")
    ...
    @RequiresPermissions("uploadwork")
    ...
    @RequiresRoles("teacher")
    @RequiresPermissions("uploadnotice")
    ...
    @RequiresPermissions("uploadartcile")
    ...
    public ResultMap uploadPic(@RequestParam("multipartFile") MultipartFile multipartFile, HttpServletRequest request){
        ...
        try {
            ...
            String pathName = "jao-xue/"+filename;
            String result = OSSUtils.uploadFile("jao-xue",pathName,filePath);
            ...
            file.delete();
            String url = "https://jao-xue.oss-cn-beijing.aliyuncs.com/"+pathName;
