...
public class VideoListController {
    ...
    @RequiresRoles(value={"teacher","student"},logical= Logical.OR)
    @RequiresPermissions("noticeList")
    ...
    @RequiresRoles(value={"teacher","student"},logical= Logical.OR)
    @RequiresPermissions("artcileList")
    ...
    @RequiresPermissions("workteachList")
    ...
    @RequiresRoles("teacher")
    @RequiresPermissions("studentList")
    ...
    @RequiresRoles("student")
    @RequiresPermissions("studentToteacher")
    ...
    @RequiresRoles("student")
    @RequiresPermissions("teacherList")
    ...
    @RequiresRoles("teacher")
    @RequiresPermissions("delstudent")
    ...
    @RequiresRoles("student")
    @RequiresPermissions("downloadvideo")
    ...
    @RequiresRoles(value={"teacher","student"},logical= Logical.OR)
    @RequiresPermissions("downloadwork")
